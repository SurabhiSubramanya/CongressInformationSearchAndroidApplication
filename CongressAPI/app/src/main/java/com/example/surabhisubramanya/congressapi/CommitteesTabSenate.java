...
public class CommitteesTabSenate extends Fragment {

    private static CommitteesTabSenate committeesTabSenate = null;
    ...
    private static ListView commSenate = null;
    ...
    public CommitteesTabSenate() {
        // Required empty public constructor
    }

    public static CommitteesTabSenate getInstance() {
        if (committeesTabSenate != null) {
            return committeesTabSenate;
        } else {
            committeesTabSenate = new CommitteesTabSenate();
            return committeesTabSenate;
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_committees_tab_senate, container, false);
    }
    ...
    public static void parseJsonResults(Context ctx, JSONObject comm_results) {
        ...
        AdapterCommittees commSenateAdapter = new AdapterCommittees(ctx, R.id.commSenateListView, populateArrayList);

        if(commSenate!=null){
            commSenate.setAdapter(commSenateAdapter);
            commSenate.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                    currentObject = (JSONObject) commSenate.getItemAtPosition(position);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        this.view = view;
        this.commSenate = (ListView) view.findViewById(R.id.commSenateListView);
        if(this.data!=null){
